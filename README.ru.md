...
1. **Онлайн:** используйте [размещённый генератор](https://jbsan.fr/mikrotik-geo-counrty-generator.php), чтобы сгенерировать файл без установки.
2. **Свой хостинг:** загрузите папку `web-gui` на веб-сервер и откройте `generator.php` в браузере.
3. Выберите WAN-интерфейс и страны для блокировки.
4. Нажмите **Сгенерировать .rsc скрипт**. Инструмент загрузит IP из [ipverse](https://github.com/ipverse/country-ip-blocks) и скомпилирует синтаксис MikroTik.
